...
{
    public partial class frmFiltroConcepto : Form
    {
        private static readonly ILog _MyLogControlEventos = log4net.LogManager.GetLogger("MyControlEventos");
        public Concepto _Concepto { get; private set; } = null;
      
        public frmFiltroConcepto()
        {
            InitializeComponent();
        }
        ...
        {
            IConceptoLN datos = new ConceptoLN();
            ...
            try
            {
                ...
                this.dgvDatos.DataSource = datos.GetConceptoByFiltro(filtro);
        ...
        private void dgvDatos_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            try
            {
                if (dgvDatos.RowCount > 0 && dgvDatos.SelectedRows.Count > 0)
                {
                    ...
                    {
                        _Concepto = dgvDatos.SelectedRows[0].DataBoundItem as Concepto;
